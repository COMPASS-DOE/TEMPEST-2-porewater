...
IDK WHY THIS CHUNK DOES NOT WORK IN MARKDOWN, BUT IT DOES IN THE CONSOLE SO JUST DO THAT....
# Import Data
```{import data, include= TRUE}
...
write_csv(PW_npoc_wflags_metadata , "../TEMPEST-2-porewater/data/TMP_PW_NPOC_TDN_L1_Jun2023-Dec2023.csv")

write_csv(PW_npoc_wflags_metadata_summarized, "../TEMPEST-2-porewater/data/TMP_PW_NPOC_TDN_L2_Summary_Jun2023-Dec2023.csv")
```
